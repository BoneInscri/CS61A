...
(display-stream-cnt (triples integers integers integers) 30)

(define triple-test (triples integers integers integers))

(define (square x) (* x x))
(define (square-sum x y) (+ (square x) (square y)))
(define test (stream-filter (lambda (x)
                              (= (square-sum (car x) (cadr x)) (caddr x))
                              ) triple-test))

(display-stream-cnt test 30)