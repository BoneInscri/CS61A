...
(define test-tmp (weighted-pairs integers integers (lambda (x) (square-sum (car x) (cadr x)))))
;(define test (stream-map (lambda (x) (square-sum (car x) (cadr x))) test-tmp) )

(define (pair-weight x)
